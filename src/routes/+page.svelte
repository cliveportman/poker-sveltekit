...
<div>
	<div class=" relative flex justify-between m-4">
		<p class="w-full text-white text-xl font-medium">Add a food</p>
		<button
			type="button"
			class="relative -top-3 -right-3 block w-auto border-0 p-2 bg-transparent text-white opacity-80 font-medium"
		>
			<svg
			...
			<div class="flex flex-col items-center">
				...
				>
					<path
						stroke-linecap="round"
						stroke-linejoin="round"
						d="M15.182 15.182a 8.0 0 0 01-6.364 0 M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z"
					/>
				</svg>
			</div>
		</button>
	...
	<div class="px-4 text-xs mb-8">
		...
		<input
			...
			bind:value={fatG}
			step="5"
			class="block w-full h-2 bg-sky-700 appearance-none cursor-pointer dark:bg-gray-700 range-slider fat opacity-80"
		/>
	</div>
